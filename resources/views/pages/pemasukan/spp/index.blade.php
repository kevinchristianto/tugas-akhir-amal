            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
                        ...
                        <li class="breadcrumb-item text-gray-700">Pembayaran SPP</li>
                    </ul>
                    <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-1 lh-0">Pembayaran SPP</h1>
                </div>
                    ...
                    <div class="card card-flush">
                        <div class="card-header pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark">History Pembayaran SPP</span>
                                <span class="text-gray-400 mt-1 fw-semibold fs-6">History pembayaran SPP</span>
                            </h3>
                        </div>
