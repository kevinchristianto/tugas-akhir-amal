...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../"/>
		<title>Login &mdash; Pemrograman Akuntansi</title>
		<meta charset="utf-8" />
				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" method="POST" action="{{ route('login') }}">
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Pemrograman Akuntansi</h1>
									<!--end::Title-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group-->
					...
					<div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
						...
						<div class="d-flex flex-center fw-semibold fs-6">
							<a href="#" class="text-muted text-hover-primary px-2">Kelompok II</a>
						</div>
						<!--end::Links-->
					</div>
					<!--end::Footer-->
